...
#private method of instance
    ...
    def _CheckStringTypeItem(self,value):
        if not isinstance(value,str):
            ...
            raise ValueError(f'String must not be numeric')
...
#         self.assertCountEqual(self.Builder.build(frecuency=False,data=['TWTR','AAPL']), [self.load_dict,self.load_dict2])

# def test_no_frecuency_list_strings(self):
#         self.load_dict['symbol']='TWTR'
#         self.load_dict['interval']='1min'
#         self.assertCountEqual(self.Builder.build(frecuency=False,data='TWTR'), [self.load_dict])
